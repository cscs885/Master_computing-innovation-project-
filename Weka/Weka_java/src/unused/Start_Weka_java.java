...
public class Start_Weka_java {
		...
		{	
			...
			String suffix = ".arff";
			String file_name_input_1 = "Similarity(Balanced,stemmer)";
			String file_name_input_2 = "Similarity(Balanced,stemmer,NGram1-3)";
			String file_name_input_3 = "Similarity(Balanced,stemmer,NGram2-3)";
			String file_name_input_4 = "Similarity(Balanced,stemmer,NGram2-3,Rainbow)"; 
				
			in1 = new BufferedReader(new FileReader(file_name_input_1+ suffix));
			in2 = new BufferedReader(new FileReader(file_name_input_2+ suffix));	
			in3 = new BufferedReader(new FileReader(file_name_input_3 + suffix));
			in4 = new BufferedReader(new FileReader(file_name_input_4 + suffix));
			
			Instances train1 = new Instances(in1);
			...
			nBayes1.buildClassifier(train1);
			serialize.write(file_name_input_1,nBayes1);
			
			
			NaiveBayes nBayes2 = new NaiveBayes();
			nBayes2.buildClassifier(train2);			
			serialize.write(file_name_input_2,nBayes2);
			
			NaiveBayes nBayes3 = new NaiveBayes();
			nBayes3.buildClassifier(train3);		
			serialize.write(file_name_input_3,nBayes3);
			
			NaiveBayes nBayes4 = new NaiveBayes();
			nBayes4.buildClassifier(train4);		
			serialize.write(file_name_input_4,nBayes4);
			
			
			//SMO
//			String classifier_smo = "smo";
//			SMO smo1 = new SMO();
//			smo1.buildClassifier(train1);
//			serialize.write(file_name_input_1+classifier_smo,smo1);	
//			
//			String classifier_smo2 = "smo";
//			SMO smo2 = new SMO();
//			smo2.buildClassifier(train2);
//			serialize.write(file_name_input_2+classifier_smo2,smo2);	
//			
//			String classifier_smo3 = "smo";
//			SMO smo3 = new SMO();
//			smo3.buildClassifier(train3);
//			serialize.write(file_name_input_3+classifier_smo3,smo3);
//			
//			String classifier_smo4 = "smo";
//			SMO smo4 = new SMO();
//			smo4.buildClassifier(train4);
//			serialize.write(file_name_input_1+classifier_smo4,smo4);
			
			//Evaluation eval0 = new Evaluation(train);
			//Instance test = train.instance(1);
			//eval0.evaluateModelOnce(nBayes,train.instance(1));
			//System.out.println(eval0.toSummaryString());		
			/*
			System.out.println("NaiveBayes(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval0.weightedFMeasure()) + 
...
//			System.out.println("NaiveBayes(Position(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval1.weightedFMeasure()) + 
...
//			System.out.println("NaiveBayes(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval3.weightedFMeasure()) + 
...
//			System.out.println("NaiveBayes(Position(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval4.weightedFMeasure()) + 
...
//			System.out.println("smo(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval0.weightedFMeasure()) + 
//			"Precision:" + String.format("%.3f",eval0.weightedPrecision()) + "Recall: " +String.format("%.3f",eval0.weightedRecall()));
//			
//			SMO smo2 = new SMO();
//			smo2.buildClassifier(train2);
...
//			System.out.println("smo2(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval1.weightedFMeasure()) + 
//			"Precision:" + String.format("%.3f",eval1.weightedPrecision()) + "Recall: " +String.format("%.3f",eval1.weightedRecall()));
//			
//			SMO smo3 = new SMO();
//			smo3.buildClassifier(train3);
...
//			System.out.println("smo2(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval2.weightedFMeasure()) + 
...
//			System.out.println("smo3(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval3.weightedFMeasure()) + 
//			"Precision:" + String.format("%.3f",eval3.weightedPrecision()) + "Recall: " +String.format("%.3f",eval3.weightedRecall()));
...
//			System.out.println("randomForest_130(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval01.weightedFMeasure())+ 
...
//			System.out.println("randomForest_130(Position((Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval11.weightedFMeasure())+ 
...
//			System.out.println("randomForest_130(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval21.weightedFMeasure())+ 
...
//			System.out.println("randomForest_130(Position(Balanced,stemmer,NGram1-3,Rainbow)) fMeasure: " + String.format("%.3f",eval31.weightedFMeasure())+ 
...
//			System.out.println("randomForest_100(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval02.weightedFMeasure())+ 
...
//			System.out.println("randomForest_100(Position(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval12.weightedFMeasure())+ 
...
//			System.out.println("randomForest_100(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval22.weightedFMeasure())+ 
...
//			System.out.println("randomForest_100(Position(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval32.weightedFMeasure())+ 
...
//			System.out.println("randomForest_75(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval03.weightedFMeasure())+ 
...
//			System.out.println("randomForest_75(Position(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval13.weightedFMeasure())+ 
...
//			System.out.println("randomForest_75(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval23.weightedFMeasure())+ 
...
//			System.out.println("randomForest_75(Position(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval33.weightedFMeasure())+ 
...
//			System.out.println("ibk_20(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval04.weightedFMeasure())+ 
...
//			System.out.println("ibk_20(Position(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval14.weightedFMeasure())+ 
...
//			System.out.println("ibk_20(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval24.weightedFMeasure())+ 
...
//			System.out.println("ibk_20(Position(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval34.weightedFMeasure())+ 
...
//			System.out.println("ibk_40(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval05.weightedFMeasure())+ 
...
//			System.out.println("ibk_40(Position(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval15.weightedFMeasure())+ 
...
//			System.out.println("ibk_40(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval25.weightedFMeasure())+ 
...
//			System.out.println("ibk_40(Position(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval35.weightedFMeasure())+ 
...
//			System.out.println("ibk_30(Position(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval06.weightedFMeasure())+ 
...
//			System.out.println("ibk_30(Position(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval16.weightedFMeasure())+ 
...
//			System.out.println("ibk_30(Position(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval26.weightedFMeasure())+ 
...
//			System.out.println("ibk_30(Position(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval36.weightedFMeasure())+ 
