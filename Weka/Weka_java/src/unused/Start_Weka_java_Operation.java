...
public class Start_Weka_java_Operation {
			...
			{	
				...
				String file_name_input_1 = "Operation(Balanced,stemmer).arff";
				String file_name_input_2 = "Operation(Balanced,stemmer,NGram1-3).arff";
				String file_name_input_3 = "Operation(Balanced,stemmer,NGram2-3).arff";
				String file_name_input_4 = "Operation(Balanced,stemmer,NGram2-3,Rainbow).arff";
				...
				System.out.println("smo(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval0.weightedFMeasure()) + 
				...
				System.out.println("smo2(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval1.weightedFMeasure()) + 
				...
				System.out.println("smo2(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval2.weightedFMeasure()) + 
				...
				System.out.println("smo3(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval3.weightedFMeasure()) + 
...
//				System.out.println("NaiveBayes(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval0.weightedFMeasure()) + 
//						"Precision:" + String.format("%.3f",eval0.weightedPrecision()) + "Recall: " +String.format("%.3f",eval0.weightedRecall()));
//				
...
//				System.out.println("NaiveBayes(Operation(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval1.weightedFMeasure()) + 
//						"Precision:" + String.format("%.3f",eval1.weightedPrecision()) + "Recall: " +String.format("%.3f",eval1.weightedRecall()));
//				
...
//				System.out.println("NaiveBayes(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval3.weightedFMeasure()) + 
//						"Precision:" + String.format("%.3f",eval3.weightedPrecision()) + "Recall: " +String.format("%.3f",eval3.weightedRecall()));
//
...
//				System.out.println("NaiveBayes(Operation(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval4.weightedFMeasure()) + 
...
//				System.out.println("randomForest_130(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval01.weightedFMeasure())+ 
...
//				System.out.println("randomForest_130(Operation((Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval11.weightedFMeasure())+ 
...
//				System.out.println("randomForest_130(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval21.weightedFMeasure())+ 
...
//				System.out.println("randomForest_130(Operation(Balanced,stemmer,NGram1-3,Rainbow)) fMeasure: " + String.format("%.3f",eval31.weightedFMeasure())+ 
...
//				System.out.println("randomForest_100(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval02.weightedFMeasure())+ 
...
//				System.out.println("randomForest_100(Operation(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval12.weightedFMeasure())+ 
...
//				System.out.println("randomForest_100(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval22.weightedFMeasure())+ 
...
//				System.out.println("randomForest_100(Operation(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval32.weightedFMeasure())+ 
...
//				System.out.println("randomForest_75(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval03.weightedFMeasure())+ 
...
//				System.out.println("randomForest_75(Operation(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval13.weightedFMeasure())+ 
...
//				System.out.println("randomForest_75(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval23.weightedFMeasure())+ 
...
//				System.out.println("randomForest_75(Operation(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval33.weightedFMeasure())+ 
...
//				System.out.println("ibk_20(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval04.weightedFMeasure())+ 
...
//				System.out.println("ibk_20(Operation(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval14.weightedFMeasure())+ 
...
//				System.out.println("ibk_20(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval24.weightedFMeasure())+ 
...
//				System.out.println("ibk_20(Operation(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval34.weightedFMeasure())+ 
...
//				System.out.println("ibk_40(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval05.weightedFMeasure())+ 
...
//				System.out.println("ibk_40(Operation(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval15.weightedFMeasure())+ 
...
//				System.out.println("ibk_40(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval25.weightedFMeasure())+ 
...
//				System.out.println("ibk_40(Operation(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval35.weightedFMeasure())+ 
...
//				System.out.println("ibk_30(Operation(Balanced,stemmer)) fMeasure: " + String.format("%.3f",eval06.weightedFMeasure())+ 
...
//				System.out.println("ibk_30(Operation(Balanced,stemmer,NGram1-3)) fMeasure: " + String.format("%.3f",eval16.weightedFMeasure())+ 
...
//				System.out.println("ibk_30(Operation(Balanced,stemmer,NGram2-3)) fMeasure: " + String.format("%.3f",eval26.weightedFMeasure())+ 
...
//				System.out.println("ibk_30(Operation(Balanced,stemmer,NGram2-3,Rainbow)) fMeasure: " + String.format("%.3f",eval36.weightedFMeasure())+ 
