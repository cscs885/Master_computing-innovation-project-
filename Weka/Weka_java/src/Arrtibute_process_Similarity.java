...
public class Arrtibute_process_Similarity {

		public  void process_similarity()throws Exception
		{	
		
			//BufferedReader reader_2 = new BufferedReader(new FileReader("C:\\Users\\34463\\Documents\\RawData1(OriText)\\RawData1(OriText)(Similarity)\\RawData1(OriText)(Similarity)(Balanced2).arff"));
			BufferedReader reader_3 = new BufferedReader(new FileReader("versionsW7.arff"));
			ArffReader arff_postion_ver1 = new ArffReader(reader_3);
			
			Instances dataset_postion_ver1 = arff_postion_ver1.getData();				
			String[] reorder_otps = new String[] {"-R","first-23,25-last,24"};
						
			String[] remove_opts = new String[] {"-R","8-9,12-22,28,41-42,44-50"};
			...
			StringToWordVector stringToWordVector_Similarity_ver1 = new StringToWordVector();
			SnowballStemmer snowballStemmer = new SnowballStemmer();
			Rainbow rainbow = new Rainbow();
			
			stringToWordVector_Similarity_ver1.setStemmer(snowballStemmer);
			stringToWordVector_Similarity_ver1.setStopwordsHandler(rainbow);
			stringToWordVector_Similarity_ver1.setInputFormat(dataset_postion_ver1);
			dataset_postion_ver1= Filter.useFilter(dataset_postion_ver1, stringToWordVector_Similarity_ver1);
			...
			String outputFile_Postion_stemmer = "similarity_process.arff";
...
//			StringToWordVector stringToWordVector_Similarity_ver2 = new StringToWordVector();
//			NGramTokenizer ngramTokenizer = new NGramTokenizer();
//			stringToWordVector_Similarity_ver2.setStemmer(snowballStemmer2);
//			stringToWordVector_Similarity_ver2.setTokenizer(ngramTokenizer);
//			stringToWordVector_Similarity_ver2.setInputFormat(dataset2_postion_ver1);
//			dataset2_postion_ver1= Filter.useFilter(dataset2_postion_ver1, stringToWordVector_Similarity_ver2);
...
//			String outputFile_Postion_stemmer_NGram1To3 = "C:\\Users\\34463\\Documents\\RawData1(OriText)\\Similarity(Balanced,stemmer,NGram1-3).arff";
...
//			StringToWordVector stringToWordVector_Similarity_ver3 = new StringToWordVector();
//			NGramTokenizer ngramTokenizer2 = new NGramTokenizer();
//			ngramTokenizer2.setNGramMinSize(2);
//			stringToWordVector_Similarity_ver3.setStemmer(snowballStemmer3);
//			stringToWordVector_Similarity_ver3.setTokenizer(ngramTokenizer2);
//			stringToWordVector_Similarity_ver3.setInputFormat(dataset3_postion_ver1);
//			dataset3_postion_ver1 = Filter.useFilter(dataset3_postion_ver1, stringToWordVector_Similarity_ver3);
...
//			String outputFile_Postion_stemmer_NGram2To3 = "C:\\Users\\34463\\Documents\\RawData1(OriText)\\Similarity(Balanced,stemmer,NGram2-3).arff";
...
//			StringToWordVector stringToWordVector_Similarity_ver4 = new StringToWordVector();
//			NGramTokenizer ngramTokenizer3 = new NGramTokenizer();
//			Rainbow rainbow2 = new Rainbow();
//			stringToWordVector_Similarity_ver4.setStemmer(snowballStemmer4);
//			stringToWordVector_Similarity_ver4.setStopwordsHandler(rainbow2);
//			stringToWordVector_Similarity_ver4.setInputFormat(dataset4_postion_ver1);
//			dataset4_postion_ver1 = Filter.useFilter(dataset4_postion_ver1, stringToWordVector_Similarity_ver4);
...
//			String outputFile_Postion_stemmer_NGram2To3_Rainbow = "C:\\Users\\34463\\Documents\\RawData1(OriText)\\Similarity(Balanced,stemmer,NGram2-3,Rainbow).arff";
