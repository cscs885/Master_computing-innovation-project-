...
public class Attribute_process_Position {
	
	//public String attributes_preprocess(String fileName) throws Exception
	
	public  void process_position ()throws Exception
	{	
		//Instances_Balance instances_Balance = new Instances_Balance();
		//instances_Balance.call_balance();
		BufferedReader reader_1 =  new BufferedReader(new FileReader("versionsW7.arff"));
		//BufferedReader reader_2 = new BufferedReader(new FileReader("C:\\Users\\34463\\Documents\\RawData1(OriText)\\RawData1(OriText)(Operation)\\RawData1(OriText)(Operation)(Balanced2).arff"));
		...
		ArffReader arff_postion_ver1 = new ArffReader(reader_1);

		
		Instances dataset_postion_ver1 = arff_postion_ver1.getData();
		Instances dataset2_postion_ver1 = arff_postion_ver1.getData();
		Instances dataset3_postion_ver1 = arff_postion_ver1.getData();
		Instances dataset4_postion_ver1 = arff_postion_ver1.getData();
		...
		String[] remove_opts = new String[] {"-R","8-9,12-22,28,41-46,48,last"};
		...
		StringToWordVector stringToWordVector_Position_ver1 = new StringToWordVector();
		...
		stringToWordVector_Position_ver1.setStemmer(snowballStemmer);
		stringToWordVector_Position_ver1.setTokenizer(ngramTokenizer3);			
		stringToWordVector_Position_ver1.setInputFormat(dataset_postion_ver1);
		dataset_postion_ver1= Filter.useFilter(dataset_postion_ver1, stringToWordVector_Position_ver1);
		
		
		String[] reorder_otps = new String[] {"-R","first-24,26-last,25"};
		...
		String outputFile_Postion_stemmer = "position_process.arff";
...
//		StringToWordVector stringToWordVector_Position_ver2 = new StringToWordVector();
//		NGramTokenizer ngramTokenizer = new NGramTokenizer();
//		stringToWordVector_Position_ver2.setStemmer(snowballStemmer);
//		stringToWordVector_Position_ver2.setTokenizer(ngramTokenizer);
//		stringToWordVector_Position_ver2.setInputFormat(dataset2_postion_ver1);
//		dataset2_postion_ver1= Filter.useFilter(dataset2_postion_ver1, stringToWordVector_Position_ver2);
...
//		String outputFile_Postion_stemmer_NGram1To3 = "C:\\Users\\34463\\Documents\\RawData1(OriText)\\Position(Balanced,stemmer,NGram1-3).arff";
...
//		StringToWordVector stringToWordVector_Position_ver3 = new StringToWordVector();
//		NGramTokenizer ngramTokenizer2 = new NGramTokenizer();
//		ngramTokenizer2.setNGramMinSize(2);
//		stringToWordVector_Position_ver3.setStemmer(snowballStemmer2);
//		stringToWordVector_Position_ver3.setTokenizer(ngramTokenizer2);
//		stringToWordVector_Position_ver3.setInputFormat(dataset3_postion_ver1);
//		dataset3_postion_ver1 = Filter.useFilter(dataset3_postion_ver1, stringToWordVector_Position_ver3);
...
//		String outputFile_Postion_stemmer_NGram2To3 = "C:\\Users\\34463\\Documents\\RawData1(OriText)\\Position(Balanced,stemmer,NGram2-3).arff";
//		saver3.setFile(new File(outputFile_Postion_stemmer_NGram2To3));
//		saver3.writeBatch();
//		
//		//Convert String to WordsVector (stemmer,NGramtokeniser,min=2,max =3,stopwordsRainbow)) ver4
//		SnowballStemmer snowballStemmer4 = new SnowballStemmer();
//		StringToWordVector stringToWordVector_Position_ver4 = new StringToWordVector();
//		NGramTokenizer ngramTokenizer3 = new NGramTokenizer();
//		Rainbow rainbow = new Rainbow();
//		ngramTokenizer3.setNGramMinSize(2);
//		stringToWordVector_Position_ver4.setStopwordsHandler(rainbow);
//		stringToWordVector_Position_ver4.setStemmer(snowballStemmer4);
//		//stringToWordVector_Position_ver4.setTokenizer(ngramTokenizer3);
//		stringToWordVector_Position_ver4.setInputFormat(dataset4_postion_ver1);
//		dataset4_postion_ver1 = Filter.useFilter(dataset4_postion_ver1, stringToWordVector_Position_ver4);
...
//		String outputFile_Postion_stemmer_NGram2To3_Rainbow = "C:\\Users\\34463\\Documents\\RawData1(OriText)\\Position(Balanced,stemmer,NGram2-3,Rainbow).arff";
